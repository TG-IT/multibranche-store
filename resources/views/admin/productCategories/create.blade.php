    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.productCategory.fields.title') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.productCategory.fields.title_helper') }}</span>
            </div>
            <div class="form-group">
