    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_national') ? 'is-invalid' : '' }}" type="number" name="id_national" id="id_national" value="{{ old('id_national', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loyal_points') ? 'is-invalid' : '' }}" type="number" name="loyal_points" id="loyal_points" value="{{ old('loyal_points', '') }}" step="1">
