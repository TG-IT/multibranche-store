...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.branch.title_singular') }}
    </div>
            ...
            <table class="table table-bordered table-striped table-hover datatable datatable-Branch">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.branch.branch_name') }}
                        </th>
                        <th>
                            {{ trans('cruds.branch.fields.branch_id') }}
                        </th>
                        <th>
                            {{ trans('cruds.branch.fields.city') }} <!-- Add City Column -->
                        </th>
                        <th>
...
<!-- Your additional JavaScript scripts go here -->
@endsection
