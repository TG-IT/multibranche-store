    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sell_price') ? 'is-invalid' : '' }}" type="number" name="sell_price" id="sell_price" value="{{ old('sell_price', '') }}" step="0.001" min="0.001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_sell_price') ? 'is-invalid' : '' }}" type="number" name="min_sell_price" id="min_sell_price" value="{{ old('min_sell_price', '') }}" step="0.001" min="0.000" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_sell_price') ? 'is-invalid' : '' }}" type="number" name="max_sell_price" id="max_sell_price" value="{{ old('max_sell_price', '') }}" step="0.001" min="0.000" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('buy_price') ? 'is-invalid' : '' }}" type="number" name="buy_price" id="buy_price" value="{{ old('buy_price', '') }}" step="0.001" min="0.001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_buy_price') ? 'is-invalid' : '' }}" type="number" name="min_buy_price" id="min_buy_price" value="{{ old('min_buy_price', '') }}" step="0.001" min="0.000" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_buy_price') ? 'is-invalid' : '' }}" type="number" name="max_buy_price" id="max_buy_price" value="{{ old('max_buy_price', '') }}" step="0.001" min="0.000" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loyal_points') ? 'is-invalid' : '' }}" type="number" name="loyal_points" id="loyal_points" value="{{ old('loyal_points', '') }}" step="1"  min="0">
