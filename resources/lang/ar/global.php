...
return [
    ...
    'sell_price_configuration'       => 'إعدادات سعر البيع',
    'buy_price_configuration'       => 'إعدادات سعر الشراء',
    'order_number'                  => 'رقم الطلبية',
    'manage_order_products'         => 'إدارة ماود الطلبية ',
    'commit_qtt'                    => 'تأكيد إستلام الكميات وإضافتها للمخزن',
    'quantities_settings'           => 'إعدادات الكميات بالمخزن',
    'quantity' => 'الكمية بالفرع',
    'target_branch' => 'الفرع',
    'you_previusly_added_this_item' => 'تم إضافة نفس المادة من قبل في نفس الفرع',
    'confirm_qtt_update' => 'هل أنت متأكد من إتمام هذه العملية ؟ سيتم تغيير حالة الطلب ولا يمكن التعديل عليه إلا بإنشاء طلب جديد أو التعديل في قسم المواد',

    'x_products_updated'=>' المواد التي تم تحديث الكميات بها : :productcount ',
    'product_not_found_for_productorder'=>'لم نجد مواد بهذا الطلب',
    'qtt_changes_commited'=>'تم تعديل كميات المواد بهذا الطلب ولا يمكن التعديل عليها إلا عن طريق قسم المواد',
    'cashier'=>'الكاشير',
    'invoice_items'=>'المواد المضافة بالفاتورة',
